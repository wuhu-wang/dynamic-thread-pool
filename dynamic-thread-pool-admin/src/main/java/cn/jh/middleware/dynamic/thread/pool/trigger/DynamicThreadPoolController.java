package cn.jh.middleware.dynamic.thread.pool.trigger;

import cn.jh.middleware.dynamic.thread.pool.sdk.domain.model.entity.ThreadPoolConfigEntity;
import cn.jh.middleware.dynamic.thread.pool.types.Response;
...
public class DynamicThreadPoolController {
    ...
    public Response<ThreadPoolConfigEntity> queryThreadPoolConfig(@RequestParam String appName, @RequestParam String threadPoolName) {
        try {
            ...
            ThreadPoolConfigEntity cache = redissonClient.<ThreadPoolConfigEntity>getBucket(cacheKey).get();
